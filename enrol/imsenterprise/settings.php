...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('enrol_imsenterprise/imsupdateusers', get_string('updateusers', 'enrol_imsenterprise'), get_string('updateusers_desc', 'enrol_imsenterprise'), 0));
